...
const LinkedInProfile = "https://www.linkedin.com/in/muhammad-bilal-b159a5292/";
    ...
    <section id="Intro" className="z-[2] flex w-full items-center py-12 md:py-16">
      <MaxWidthWrapper>
        <div className="max-w-4xl mx-auto text-center md:text-left">
          {/* Section heading */}
          <h2 className="text-[#f0abfc] text-4xl md:text-5xl lg:text-6xl font-extrabold font-['Plus_Jakarta_Sans'] mb-6 tracking-tight">
            About NCAT
          </h2>
